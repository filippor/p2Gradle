...
public class P2Plugin implements Plugin<Project> {
    ...
    public void apply(final Project prj) {
        ...
        final RepositoryHandler rh = prj.getRootProject().getRepositories();
        rh.mavenCentral();
        rh.maven(mvn -> {
        ...
        final FrameworkTaskConfigurator taskConfigurator = new FrameworkTaskConfigurator(prj, Paths.get(System.getProperty("user.home"), ".gradle", "caches", "p2", "pool"));
